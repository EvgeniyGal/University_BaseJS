...
// function dataTransform(name: string, age: number): [string, number] {
//   return [name, age];
// }

// console.log(dataTransform("alex", 56));
...
// function calcAverageScore(student: Student): number {
//   return student.achievements.reduce((acc, el, idx, arr) => {
//     if (arr.length - 1 !== idx) {
//       acc += el;
//       return acc;
//     }
...
// console.log(
//   calcAverageScore({ name: "Vasil", age: 23, achievements: [10, 10, 20, 20] })
// );
...
function getOrderInfo(order: Order): [number, string] {
  return [

...
// const str = "i aM heLLo worD froM Odesa";
// const tokenArr = "9Fg3534".split("");
...
// function mixLetters(element, index) {
...
//           acc.push(item);
//           if (tokenArr.length > 0) {
//             acc.push(tokenArr.shift());
//           }
//           return acc;
//         },
//         index === 0 ? [] : [tokenArr.shift()]
//       )
//       .join("");
//   } else {
//     return element;
...
//   // good luck
//   const tempArr = array.filter((e) => e % 2 === 0);
//   return tempArr.splice(tempArr.length - number, number);
// }
...
// tabs is an array of titles of each site open within
